            ...
            <div class="row">
              <div class="large-12 columns">
                <div class="panel" id="worked">
                  <h3><a href="http://foundation.zurb.com/docs">My Work/Portfolio</a></h3>
                  <p>See what I've done as an <a href="#">experience designer</a>, <a href="">web developer</a> and <a href="">interactive producer</a>.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="large-12 columns">
                <div class="panel" id="proof">    		
                  <h3><a href="http://github.com/zurb/foundation">My Resume</a></h3>
        	        <p><a href="#" data-reveal-id="resumeModal" data-reveal>View</a> or <a href="">download</a> curriculum vitae</p>
        	      </div>
              </div>
            </div>
            <div class="row arrow down">
